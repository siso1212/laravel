				...
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="{{route('menProducts')}}">Mens</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="{{route('otherProducts')}}">Other</a></h4>
								</div>
							</div>
						...
						<div class="price-range"><!--price-range-->
							<h2>To Pay By Mobile Banking</h2>
							<div class="well text-center">
								 <input type="text" class="span2" value="" data-slider-min="0" data-slider-max="600" data-slider-step="5" data-slider-value="[250,450]" id="sl2" ><br />
								 <b class="pull-left">$ 0</b> <b class="pull-right">Oromia Int Bank  </b>
							</div>
						</div><!--/price-range-->
						
						<div class="shipping text-center"><!--shipping-->
							<img src="{{asset('images/home/ad.jpg')}}" alt="ad" />
						</div><!--/shipping-->
                    	...
                    	<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
                                        ...
                                        {{$product->id}}
											<img src="{{Storage::disk('local')->url('pimages/'.$product->image)}}" alt="" />
											<h2>{{$product->price}}</h2>
											<p> {{$product->name}}</p>
