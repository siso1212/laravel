				...
				<table class="table table-condensed">
                    ...
                    <tr>
							<td class="cart_product">
								<a href=""><img src="{{Storage::disk('local')->url('pimages/'.$item['data']['image'])}}"width="100" hieght="100" alt=""></a>
							</td>
							...
							<td class="cart_quantity">
								<div class="cart_quantity_button">
									...
									<a class="cart_quantity_down"type="number" href="{{route('DecreaseSingleProduct',['id'=>$item['data']['id']])}}"> - </a>
								</div>
							</td>
							<td class="cart_total">
